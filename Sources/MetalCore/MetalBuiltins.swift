...
public struct MetalBuiltins {
    ...
    public static let types: [CompletionInfo] = [
        ...
        CompletionInfo(
            label: "char", detail: "8-bit signed integer",
            documentation: "8-bit signed integer type"),
        CompletionInfo(
            label: "uchar", detail: "8-bit unsigned integer",
            documentation: "8-bit unsigned integer type"
        ),
        CompletionInfo(
            label: "short", detail: "16-bit signed integer",
        ...
        CompletionInfo(
            label: "half", detail: "16-bit floating point",
            documentation: "16-bit floating point type"),
        CompletionInfo(
            label: "float", detail: "32-bit floating point",
    ...
    public static let mathFunctions: [CompletionInfo] = [
        ...
        CompletionInfo(
            label: "cos", detail: "float cos(float x)", documentation: "Cosine function"),
        CompletionInfo(
            label: "tan", detail: "float tan(float x)", documentation: "Tangent function"),
        CompletionInfo(
        ...
        CompletionInfo(
            label: "log", detail: "float log(float x)", documentation: "Natural logarithm"),
        CompletionInfo(
            label: "log2", detail: "float log2(float x)", documentation: "Base-2 logarithm"),
        ...
        CompletionInfo(
            label: "ceil", detail: "float ceil(float x)",
            documentation: "Round up to nearest integer"),
        CompletionInfo(
            label: "floor", detail: "float floor(float x)",
            documentation: "Round down to nearest integer"
        ),
        CompletionInfo(
            label: "round", detail: "float round(float x)",
        ...
        CompletionInfo(
            label: "sign", detail: "float sign(float x)",
    ...
    public static let textureFunctions: [CompletionInfo] = [
        ...
        CompletionInfo(
            label: "read", detail: "float4 read(uint2 coord)",
            documentation: "Read texel at coordinates"),
        CompletionInfo(
