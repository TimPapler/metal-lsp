...
public struct MetalBuiltins {
  ...
  public static let types: [CompletionInfo] = [
    // Scalar types
    CompletionInfo(
      label: "bool", detail: "Boolean type", documentation: "Boolean type (true or false)"),
    CompletionInfo(
      label: "char", detail: "8-bit signed integer", documentation: "8-bit signed integer type"),
    CompletionInfo(
      label: "uchar", detail: "8-bit unsigned integer", documentation: "8-bit unsigned integer type"
    ),
    CompletionInfo(
      label: "short", detail: "16-bit signed integer", documentation: "16-bit signed integer type"),
    CompletionInfo(
      label: "ushort", detail: "16-bit unsigned integer",
      documentation: "16-bit unsigned integer type"),
    CompletionInfo(
      label: "int", detail: "32-bit signed integer", documentation: "32-bit signed integer type"),
    CompletionInfo(
      label: "uint", detail: "32-bit unsigned integer",
      documentation: "32-bit unsigned integer type"),
    CompletionInfo(
      label: "half", detail: "16-bit floating point", documentation: "16-bit floating point type"),
    CompletionInfo(
      label: "float", detail: "32-bit floating point", documentation: "32-bit floating point type"),
    ...
    // Texture types
    CompletionInfo(
      label: "texture1d", detail: "1D texture",
      documentation: "1D texture type with template type for pixel data"),
    CompletionInfo(label: "texture1d_array", detail: "1D texture array"),
    CompletionInfo(
      label: "texture2d", detail: "2D texture",
      documentation: "2D texture type with template type for pixel data"),
    ...
    // Sampler type
    CompletionInfo(
      label: "sampler", detail: "Texture sampler",
      documentation: "Sampler state for texture sampling operations"),
  ]
  ...
  public static let mathFunctions: [CompletionInfo] = [
    ...
    CompletionInfo(
      label: "asin", detail: "float asin(float x)", documentation: "Arc sine function"),
    CompletionInfo(
      label: "acos", detail: "float acos(float x)", documentation: "Arc cosine function"),
    CompletionInfo(
      label: "atan", detail: "float atan(float y_over_x)", documentation: "Arc tangent function"),
    CompletionInfo(
      label: "atan2", detail: "float atan2(float y, float x)",
      documentation: "Two-argument arc tangent"),
    CompletionInfo(label: "sinh", detail: "float sinh(float x)", documentation: "Hyperbolic sine"),
    CompletionInfo(
      label: "cosh", detail: "float cosh(float x)", documentation: "Hyperbolic cosine"),
    CompletionInfo(
      label: "tanh", detail: "float tanh(float x)", documentation: "Hyperbolic tangent"),

    // Exponential and logarithmic
    CompletionInfo(
      label: "pow", detail: "float pow(float x, float y)",
      documentation: "Returns x raised to the power y"),
    CompletionInfo(
      label: "exp", detail: "float exp(float x)", documentation: "Natural exponentiation"),
    CompletionInfo(
      label: "exp2", detail: "float exp2(float x)", documentation: "Base-2 exponentiation"),
    ...
    CompletionInfo(
      label: "rsqrt", detail: "float rsqrt(float x)", documentation: "Reciprocal square root"),

    // Common functions
    CompletionInfo(label: "abs", detail: "float abs(float x)", documentation: "Absolute value"),
    CompletionInfo(
      label: "ceil", detail: "float ceil(float x)", documentation: "Round up to nearest integer"),
    CompletionInfo(
      label: "floor", detail: "float floor(float x)", documentation: "Round down to nearest integer"
    ),
    CompletionInfo(
      label: "round", detail: "float round(float x)", documentation: "Round to nearest integer"),
    CompletionInfo(
      label: "trunc", detail: "float trunc(float x)", documentation: "Truncate to integer"),
    CompletionInfo(
      label: "fract", detail: "float fract(float x)", documentation: "Fractional part"),
    CompletionInfo(
      label: "fmod", detail: "float fmod(float x, float y)",
      documentation: "Floating-point remainder"),
    CompletionInfo(
      label: "min", detail: "float min(float x, float y)", documentation: "Minimum value"),
    CompletionInfo(
      label: "max", detail: "float max(float x, float y)", documentation: "Maximum value"),
    CompletionInfo(
      label: "clamp", detail: "float clamp(float x, float min, float max)",
      documentation: "Clamp value to range"),
    CompletionInfo(
      label: "mix", detail: "float mix(float x, float y, float a)",
      documentation: "Linear interpolation"),
    CompletionInfo(
      label: "step", detail: "float step(float edge, float x)", documentation: "Step function"),
    CompletionInfo(
      label: "smoothstep", detail: "float smoothstep(float edge0, float edge1, float x)",
      documentation: "Smooth step function"),
    CompletionInfo(
      label: "sign", detail: "float sign(float x)", documentation: "Sign of value (-1, 0, or 1)"),
  ]
  ...
  public static let geometricFunctions: [CompletionInfo] = [
    CompletionInfo(
      label: "dot", detail: "float dot(float2 x, float2 y)",
      documentation: "Dot product of two vectors"),
    CompletionInfo(
      label: "cross", detail: "float3 cross(float3 x, float3 y)",
      documentation: "Cross product of two 3D vectors"),
    CompletionInfo(
      label: "length", detail: "float length(float2 x)", documentation: "Length of vector"),
    CompletionInfo(
      label: "distance", detail: "float distance(float2 p0, float2 p1)",
      documentation: "Distance between two points"),
    CompletionInfo(
      label: "normalize", detail: "float2 normalize(float2 x)",
      documentation: "Normalize vector to unit length"),
    CompletionInfo(
      label: "faceforward", detail: "float2 faceforward(float2 N, float2 I, float2 Nref)",
      documentation: "Orient vector to face forward"),
    CompletionInfo(
      label: "reflect", detail: "float2 reflect(float2 I, float2 N)",
      documentation: "Reflect vector"),
    CompletionInfo(
      label: "refract", detail: "float2 refract(float2 I, float2 N, float eta)",
      documentation: "Refract vector"),
  ]
  ...
  public static let textureFunctions: [CompletionInfo] = [
    CompletionInfo(
      label: "sample", detail: "float4 sample(sampler s, float2 coord)",
      documentation: "Sample texture with sampler"),
    CompletionInfo(
      label: "read", detail: "float4 read(uint2 coord)", documentation: "Read texel at coordinates"),
    CompletionInfo(
      label: "write", detail: "void write(float4 color, uint2 coord)",
      documentation: "Write color to texture at coordinates"),
    CompletionInfo(
      label: "get_width", detail: "uint get_width()", documentation: "Get texture width"),
    CompletionInfo(
      label: "get_height", detail: "uint get_height()", documentation: "Get texture height"),
    CompletionInfo(
      label: "get_depth", detail: "uint get_depth()", documentation: "Get texture depth"),
  ]
  ...
  public static let attributes: [CompletionInfo] = [
    ...
    CompletionInfo(
      label: "[[texture(n)]]", detail: "Texture binding point", insertText: "[[texture(${1:0})]]"),
    CompletionInfo(
      label: "[[sampler(n)]]", detail: "Sampler binding point", insertText: "[[sampler(${1:0})]]"),
    ...
    CompletionInfo(
      label: "[[user(name)]]", detail: "User-defined attribute", insertText: "[[user(${1:name})]]"),
